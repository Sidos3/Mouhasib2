            ...
            <div class="user_card">
                <div class="d-flex justify-content-center">
                    <div class="brand_logo_container">
                        <a href="index.html"><img src="{{ asset('images/logo.jpeg') }}"  class="brand_logo" alt="Logo"></a>
                    </div>
                </div>
                <div class="d-flex justify-content-center form_container">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="name" class="form-control input_user @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="اسم المستخدم" autofocus>
                            @error('name')
                        ...
                        <div class="d-flex justify-content-center mt-3 register_container">
                            <button type="submit" name="button" class="btn register_btn">تسجيل</button>
                        </div>
                    </form>
                </div>
                <div class="mt-4">
